# Siglas — acronym registry

Alphabetical registry of Brazilian institutional acronyms used
throughout this directory. Each entry: full name, one-line function,
file pointer where the acronym is discussed in depth (when applicable).

This file is built for fast grep: search any acronym to get
disambiguation and a pointer to the substantive file.

**Topics / keywords**: acronyms, siglas, abbreviations, institutional
names, glossary.
...
- **ACP** — Ação Civil Pública. Collective-interest civil action regulated by Lei 7.347/1985. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md), [`topics/improbidade.md`](topics/improbidade.md)
- **ADC** — Ação Declaratória de Constitucionalidade. Abstract control of constitutionality before the STF.
- **ADI / ADIn** — Ação Direta de Inconstitucionalidade. Abstract control of constitutionality before the STF.
- **ADPF** — Arguição de Descumprimento de Preceito Fundamental. STF action to protect constitutional fundamental precepts.
- **AGU** — Advocacia-Geral da União. Federal executive's legal counsel.
- **AIJE** — Ação de Investigação Judicial Eleitoral. Electoral abuse-of-power action. → [`topics/processo-eleitoral.md`](topics/processo-eleitoral.md)
- **AIME** — Ação de Impugnação de Mandato Eletivo. Action to revoke an elected mandate. → [`topics/processo-eleitoral.md`](topics/processo-eleitoral.md)
- **AIPRC** — Ação de Impugnação de Pedido de Registro de Candidatura. Pre-election challenge to candidacy registration. → [`topics/processo-eleitoral.md`](topics/processo-eleitoral.md)
- **ANATEL** — Agência Nacional de Telecomunicações. Federal telecom regulator.
- **ANEEL** — Agência Nacional de Energia Elétrica. Federal electricity regulator.
- **ANP** — Agência Nacional do Petróleo. Federal oil regulator.
- **ANPD** — Autoridade Nacional de Proteção de Dados. Data protection authority (autarquia from Lei 14.460/2022). → [`topics/transparencia-dados.md`](topics/transparencia-dados.md)
- **ANPP** — Acordo de Não Persecução Penal. Criminal-side settlement (CPP Art. 28-A, Lei 13.964/2019). → [`topics/anticorrupcao-penal.md`](topics/anticorrupcao-penal.md)
- **ANS** — Agência Nacional de Saúde Suplementar. Health-insurance regulator.
- **ANVISA** — Agência Nacional de Vigilância Sanitária. Sanitary surveillance.
- **ARE** — Agravo em Recurso Extraordinário. Procedural step before the STF.
- **Audesp** — Auditoria Eletrônica de Órgãos Públicos. TCE-SP electronic audit / data system. → [`topics/tribunais-contas.md`](topics/tribunais-contas.md)
...
- **DataJud** — Base Nacional de Dados do Poder Judiciário. CNJ unified judicial-data base (Res. 331/2020). → [`topics/cnj-administracao-judicial.md`](topics/cnj-administracao-judicial.md)
- **DATASUS** — Departamento de Informática do SUS. SUS data infrastructure (SIH, SIA, SIM, SINASC, SINAN, etc.). → [`topics/transparencia-dados.md`](topics/transparencia-dados.md)
...
- **ECA** — Estatuto da Criança e do Adolescente (Lei 8.069/1990). Child welfare statute.
- **EC** — Emenda Constitucional. Constitutional amendment.
- **e-Proc** — CJF-developed case-management platform used by TRFs and some TJs. → [`topics/cnj-administracao-judicial.md`](topics/cnj-administracao-judicial.md)
- **e-SAJ / ESAJ / SAJ** — Sistema de Automação da Justiça. Softplan-developed platform used by TJSP and many TJs. → [`topics/cnj-administracao-judicial.md`](topics/cnj-administracao-judicial.md)
- **e-SIC** — Federal LAI request portal (now integrated into Fala.BR). → [`topics/transparencia-dados.md`](topics/transparencia-dados.md)

## F

- **Fala.BR** — Federal unified ouvidoria platform (CGU). Successor / integrator of e-SIC. → [`topics/transparencia-dados.md`](topics/transparencia-dados.md)
- **FEFC** — Fundo Especial de Financiamento de Campanha. Public campaign-finance fund created by Lei 13.487/2017. → [`topics/partidos-e-sistema-eleitoral.md`](topics/partidos-e-sistema-eleitoral.md)
- **FGTS** — Fundo de Garantia do Tempo de Serviço. Mandatory employer contribution to worker savings fund. → [`topics/justica-trabalho.md`](topics/justica-trabalho.md)
- **FINBRA** — Finanças do Brasil. STN's consolidated municipal fiscal database (largely absorbed into SICONFI). → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
- **FPE** — Fundo de Participação dos Estados. Constitutional revenue-sharing fund for states. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
- **FPM** — Fundo de Participação dos Municípios. Constitutional revenue-sharing fund for municipalities. The FPM step function is a canonical RD instrument. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
- **FUNDEB** — Fundo de Manutenção e Desenvolvimento da Educação Básica. Permanent (post-EC 108/2020) education fund. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
- **FUNDEF** — Predecessor of FUNDEB (1996–2007).

## G

- **GAECO** — Grupo de Atuação Especial de Combate ao Crime Organizado. Organized-crime task force within MPs. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
...
- **IBGE** — Instituto Brasileiro de Geografia e Estatística. Federal statistics agency.
...
- **IPVA** — Imposto sobre a Propriedade de Veículos Automotores. State motor-vehicle tax.
- **IR** — Imposto de Renda. Federal income tax.
- **IRRF / IRPF / IRPJ** — Withholding / individual / corporate income tax variants.
- **IS** — Imposto Seletivo. Federal excise on harmful goods under EC 132/2023 reform.
- **ISS** — Imposto sobre Serviços de Qualquer Natureza. Municipal services tax. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
...
- **MAC** — Média e Alta Complexidade. SUS funding component (pre-2017 structure).
- **MF** — Ministério da Fazenda (current Ministério da Fazenda from 2023; previously merged into Ministério da Economia 2019–2022).
- **MJ** — Ministério da Justiça (current Ministério da Justiça e Segurança Pública).
- **MP** — Ministério Público. The Brazilian Ministério Público as a whole. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md), [`topics/funcoes-essenciais.md`](topics/funcoes-essenciais.md)
- **MPC** — Ministério Público de Contas. MP branch operating before Tribunais de Contas. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MPDFT** — Ministério Público do Distrito Federal e Territórios. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MPE** — Ministério Público Estadual. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MPF** — Ministério Público Federal. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MPM** — Ministério Público Militar. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MPSP** — Ministério Público do Estado de São Paulo.
- **MPT** — Ministério Público do Trabalho. → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MPU** — Ministério Público da União (umbrella for MPF, MPT, MPM, MPDFT). → [`topics/ministerio-publico.md`](topics/ministerio-publico.md)
- **MS** — Mandado de Segurança. Constitutional writ for clear individual rights.
- **MTFC** — Ministério da Transparência, Fiscalização e Controle. Temer-era name for CGU (2016–2018).
...
- **RPPS** — Regime Próprio de Previdência Social. Civil-servant pension regimes.
- **RREO** — Relatório Resumido de Execução Orçamentária. LRF bimonthly budget report. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
- **RU** — Regime Único / Regime Jurídico Único (Lei 8.112/1990).

## S

- **SAJ** — see ESAJ.
- **SIA** — Sistema de Informações Ambulatoriais (SUS).
- **SIC** — Serviço de Informação ao Cidadão. LAI intake service.
- **SICONFI** — Sistema de Informações Contábeis e Fiscais do Setor Público Brasileiro. STN consolidated fiscal database. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
- **SICONV** — Sistema de Convênios. Federal convênios database (now Plataforma +Brasil). → [`topics/transparencia-dados.md`](topics/transparencia-dados.md)
- **SIH** — Sistema de Informações Hospitalares (SUS).
- **SIM** — Sistema de Informações de Mortalidade (SUS).
- **SINAN** — Sistema de Informação de Agravos de Notificação (SUS).
- **SINASC** — Sistema de Informações de Nascidos Vivos (SUS).
...
- **TRE** — Tribunal Regional Eleitoral. Regional electoral court. → [`topics/justica-eleitoral.md`](topics/justica-eleitoral.md)
- **TRF** — Tribunal Regional Federal. Regional federal court. → [`topics/justica-federal.md`](topics/justica-federal.md)
- **TRT** — Tribunal Regional do Trabalho. Regional labor court. → [`topics/justica-trabalho.md`](topics/justica-trabalho.md)
- **TSE** — Tribunal Superior Eleitoral. National electoral court. → [`topics/justica-eleitoral.md`](topics/justica-eleitoral.md)
- **TST** — Tribunal Superior do Trabalho. National labor court. → [`topics/justica-trabalho.md`](topics/justica-trabalho.md)

## V

- **VAF** — Valor Adicionado Fiscal. Value-added measure used to distribute the ICMS quota-parte to municipalities. → [`topics/federalismo-fiscal.md`](topics/federalismo-fiscal.md)
